...
else
   {
    ...
    var basicBot = {
        ...
        settings: {
            ...
            scriptLink: "https://rawgit.com/PowerOfMad/UL-Bot/master/basicBot.js",
            ...
            ballCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                            ...
                            API.sendChat(subChat(basicBot.chat.balls, {name: chat.un, botname: basicBot.settings.botName, question: argument, response: basicBot.chat.balls[randomBall]}));
                     }
                }
            },
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (msg.length !== cmd.length) {
                            ...
                            {
                                $.getJSON(
                                    "https://giphy.com/giphytv/random",
                                    {
                                        "format": "json",
                                        "api_key": api_key,
                                        "rating": rating,
            ...
            helpCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        var link = "(http://prntscr.com/bw2l46)";
